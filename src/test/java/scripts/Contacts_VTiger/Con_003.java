...
//		Cell cMailS = r.getCell(5);
//		Cell cMailCoun = r.getCell(6);
...
//		driver.findElement(By.name("mailingstate")).sendKeys(conMailState);
//		driver.findElement(By.name("mailingcountry")).sendKeys(conMailCountry);
//		driver.findElement(By.name("button")).click();
		CreateNewContact contact = new CreateNewContact(driver);
		contact.createNewContact(conLastName, conEmail, conMob, conMailCity, conMailState, conMailCountry);
